...
class _HomeDashboardState extends State<HomeDashboard>
  ...
  void _selectLocation(LocationSafetyScore location) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${location.locationName} safety score: ${location.safetyScore}/100'),
        backgroundColor: _getSafetyColor(location.safetyScore),
      ...
      builder: (context) => Container(
        ...
        child: Column(
          children: [
            ...
            ListTile(
              leading: Icon(Icons.qr_code, color: Colors.green.shade600),
